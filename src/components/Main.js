...
import Tradeangel from '../images/tradeangelsnip.jpg'
    ...
    return (
      <div ref={this.props.setWrapperRef} id="main" style={this.props.timeout ? { display: 'flex' } : { display: 'none' }}>
        ...
        <article id="work" className={`${this.props.article === 'work' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{ display: 'none' }}>
          ...
          <a href='https://thetradeangel.com' target="_blank" rel="noreferrer">
            <span className="image main"><img src={Tradeangel} alt="TradeAngel" /></span>
          </a>
          <h3>TradeAngel:</h3>
          <p>Wholesale commodity trading platform that connects vetted suppliers to vetted buyers. Clients can transact safely knowing that the buyer's funds have been verified and that the product and it's supplier are real.</p>
          <h3>Technologies and Services used:</h3>
        ...
        <article id="about" className={`${this.props.article === 'about' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{ display: 'none' }}>
          ...
          <div style={{ backgroundColor: '#ffffff80', display: 'flex', justifyContent: 'center', flexWrap: 'wrap', borderRadius: 5 }}>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              <svg viewBox="0 0 128 128" style={{ width: '6rem', margin: '1rem', fill: '#61DAFB' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              <svg viewBox="0 0 128 128" style={{ width: '6rem', margin: '1rem' }}>
              ...
              <h3 style={{ color: 'black' }}>Express</h3>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              <svg viewBox="0 0 128 128" style={{ width: '6rem', margin: '1rem', fill: '#61DAFB' }}>
        ...
        <article id="contact" className={`${this.props.article === 'contact' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{ display: 'none' }}>
          ...
          <ul className="icons">
            ...
            <li><a href="https://www.facebook.com/christian.kamalu.7" className="icon fa-facebook"><span className="label">Facebook</span></a></li>
            <li><a href="https://www.instagram.com/christian_kamalu/" className="icon fa-instagram"><span className="label">Instagram</span></a></li>
            <li><a href="https://github.com/ChristianKamalu" className="icon fa-github"><span className="label">GitHub</span></a></li>
          </ul>
          {close}
        </article>
